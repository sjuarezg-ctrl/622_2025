...
Answer: The median will remain the same because it is resistant to changes in the data. The median of the remaining 9 people will be 50.
...
::: callout-note
0.5/1 - Needed to describe the distribution.
:::
...
Answer: There would be two variables. IV would be child care, DV would be voter turnout. The sample would be families with young children and adults who are eligible for voting.

::: callout-note
This sounds like your population, not sample.
:::
...
::: callout-note
Assigning the treatment by county is unlikely to produce two groups that are identical, on average, prior to treatment. People who live in different counties are likely to be different from one another in important ways.

Also, the people who did not receive the ad still get treated. It will be difficult to parse out the role the ad played.
:::
...
::: callout-note
2/3 - Judge this by the proportion within each group, not the count.
:::
