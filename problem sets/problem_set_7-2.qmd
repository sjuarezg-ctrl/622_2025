...
Answer: Given that the p-value is smaller than the 0.05, then we can reject the null hypothesis that there is no relationship between age and enjoyment of watching golf.
