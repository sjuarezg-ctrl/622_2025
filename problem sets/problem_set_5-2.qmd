...
(0.5 - 1.96*sqrt(0.5*(1-0.5)/50000)) * 50000
```
For 500 times the interval would be 228 through 272. 
For 5000 times the interval would be 2431 to 2569.
For 50000 times the interval would be 24781 to 25219.
